...
const mySkill = {
  ...
  intermediate: [
    ...
    },
    {
      ...
      shortName: "Next.js",
      fullName: "Next.js",
      description: "React framework for SSR, SSG and full-stack web applications",
    ...
    {
      icon: "mdi:console",
      shortName: "Shell Script",
      fullName: "Bash / Shell Scripting",
      description: "Automate build, deployment and workflow scripts",
    },
  ],
  basic: [
    {
